<x-app-layout>
    ...
    <form method="POST" action="{{ route('blogs.store')}} " class="py-12 mx-auto max-w-5xl px-3 md:px-6 lg:px-8">
        @csrf
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input value="{{ old('title')}}" type="text" name="title" id="title" autocomplete="given-name"
                ...
                <div class="sm:col-span-3">
                    <label for="tags" class="block text-sm font-medium leading-6 text-gray-900">Tags (must be comma
                        separated)</label>
                    <div class="mt-2">
                        <input value="{{ old('tags')}}" type="text" name="tags" id="tags" autocomplete="given-name"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
    ...
    hover:drop-shadow-3xl px-3 py-2 mt-4">Create</button>
        </div>
    </form>
